...
Plot을 모아서 보여주는 기능이 추가되었다. Matlab만 쓰던 사람들은 처음에 어색하고 불편할 수도 있지만 꾸준히 사용하다 보면 이것의 유용함을 느끼게 된다. 한번에 50개 이상씩 Plot을 하거나 Debugging이 끝나고 결과만 자주 보는 경우에 매우 유용한 기능이다. 클릭 한번으로 Plot 창에 출력된 그림들은 모두 저장할 수도 있다.  
