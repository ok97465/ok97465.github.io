...
Polar grid 적분을 위해서 Jacobian matrix에 의해서 추가된 $\left|U\right|$는 주파수 영역에서 Filtering, 영상 영역에서는 Convolution으로 해설 될 수 있다. 그래서 위와 같은 변환을 filtered backprojection 혹은 Convolution backprojection이라고 부른다.
<br>  
