...
Python을 사용하다 보면 import 명령을 치는 것이 귀찮을 때가 있다. 이런 사람들을 위해 Pycharm은 Auto import 기능을 지원한다. 위의 popup 기능을 활성화 하고 Editor에서 import하지 않은 명령을 치면 자동 import 할 것 인가를 물어 본다.
